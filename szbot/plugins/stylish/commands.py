from szbot.plugins.stylish.fonts import Fonts
from pyrogram import filters
from pyrogram.types import InlineKeyboardButton, InlineKeyboardMarkup
from szbot import sz

@sz.on_message(filters.command("text"))
...
@sz.on_callback_query(filters.regex('^nxt'))
async def nxt(c, m):
    if m.data == "nxt":
        buttons = [[
...
@sz.on_callback_query(filters.regex('^style'))
async def style(c, m):
    await m.answer()
