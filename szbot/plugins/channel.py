...
@szimagebot |**User** : `{} `|**Time**: `{}`
"""
        await rose.send_photo(chat_id=CHANNEL,photo="https://telegra.ph/file/77e05e0b5bd6a60eb5ca9.jpg",caption=picmetxt.format(message.from_user.mention), reply_markup=picmebtns)
